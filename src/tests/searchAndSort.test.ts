  ...
  describe("searchEntitiesMultiTerm", () => {
    it("searches with multiple terms", () => {
      const entities: EntityItem[] = [
        { id: "1", name: "Apple Red", date: "2023-01-01T00:00:00.000Z", value: 100 },
        { id: "2", name: "Apple Green", date: "2023-01-02T00:00:00.000Z", value: 150 },
        { id: "3", name: "Banana Yellow", date: "2023-01-03T00:00:00.000Z", value: 200 },
      ];
...
describe("Sort Utilities", () => {
  ...
  describe("sortByValue", () => {
    ...
    it("sorts values in descending order", () => {
      const sorted = [...mockEntities].sort((a, b) => sortByValue(a, b, "desc"));
